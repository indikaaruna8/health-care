...
<template>
    ...
    <div
        ...
        <header
            class="v-toolbar v-toolbar--collapse-start v-toolbar--flat v-toolbar--density-compact bg-primary v-theme--light v-locale--is-ltr v-app-bar position-fixed"
            style="top: 0px; z-index: 910; transform: translateY(0px); position: absolute; left: 0px; width: calc(100% - 0px);"
            id="nav-bar-primary" role="banner"><!---->
            <div class="v-toolbar__content" style="height: 48px;">

            </div>
        </header>
        <header
            class="v-toolbar v-toolbar--collapse-start v-toolbar--density-default bg-white v-theme--light v-locale--is-ltr v-app-bar border-color-grey-400 position-fixed"
            style="top: 48px; z-index: 908; transform: translateY(0px); position: absolute; left: 0px; width: calc(100% - 0px);"
            id="nav-bar-secondary" role="navigation" aria-label="Primary navigation">
            <div class="v-toolbar__content" style="height: 70px;">
                <nav class="flex items-center justify-end gap-4 py-1.5 px-4">
